...
arms_list = [
    ...
    ArmorPiece(2, "arms", 4, 12, 21, 4, 15, 19),
...
exotics = {
    "helmet": [
        ArmorPiece(1, "Crown of Tempests", 5, 8, 26, 18, 8, 19),
    ...
    "chest": [],
    "legs": [
        ArmorPiece(1, "Transversive Steps", 5, 27, 16, 16, 12, 9),
        ...
        ArmorPiece(5, "Transversive Steps", 5, 8, 25, 8, 9, 18)
    ]
}
